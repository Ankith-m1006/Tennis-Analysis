...
def process_video(input_video_path):
    ...
    player_detections = player_tracker.detect_frames(video_frames,
                                                     read_from_stub=True,
                                                     stub_path="tracker_stubs/player_detctions.pkl"
                                                     )
    ball_detections = ball_tracker.detect_frames(video_frames,
                                                 read_from_stub=True,
                                                 stub_path=r"C:\Users\ankit\OneDrive\Desktop\Tennis\tracker_stubs\ball_detctions.pkl"
                                                 )
    ...
    output_video_path = tempfile.mktemp(suffix=".avi", dir="output_videos")
    save_video(output_video_frames, output_video_path)

    return output_video_path, player_stats_data_df
